        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ui.vertical_centered(|ui| {
                ...
                ui.painter().line_segment(
                    ...
                    egui::Stroke::new(1.0, egui::Color32::from_rgba_premultiplied(201, 168, 76, 60)),
                );
                ...
                ui.horizontal(|ui| {
                    ui.add(egui::Label::new(
                        egui::RichText::new("出生年份").size(14.0),
                    ));
                    ui.add(
                ...
                if ui
                    .add_sized(
                        ...
                        egui::Button::new(
                            egui::RichText::new("计算").size(16.0),
                        )
